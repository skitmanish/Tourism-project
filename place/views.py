...
def detail(request,place_id):
    ...
    if place_id==320:
        ...
        de='Nagaur Tourism'
        de2='Nagaur'
        de1='tourism development corporation near Nagaur, Rajasthan'
    if place_id==321:
    ...
    if place_id==336:
        ...
        de='Jaipur_Zoo'
        de1='Jaipur Zoo, Museum Road, Ram Niwas Garden, Kailash Puri, Ramniwas Bagh, Jaipur, Rajasthan'
        de2='Jaipur Zoo'
    if place_id==337:
    ...
    if place_id==86:
            url='https://en.wikipedia.org/wiki/Indira_Gandhi_Stadium,_Solapur'
            de='Indira Gandhi Stadium, Solapur'
            de1='Indira Gandhi Stadium, National Highway 50, Sidheshwar Temple Area, Solapur, Maharashtra'
